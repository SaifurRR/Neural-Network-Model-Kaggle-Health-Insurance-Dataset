...
my_model.fit(features_train_scaled,labels_train,epochs=40,batch_size=1,verbose=1)  #fit

res_mse, res_mae=my_model.evaluate(features_test_scaled,labels_test,verbose=0) #evaluate
